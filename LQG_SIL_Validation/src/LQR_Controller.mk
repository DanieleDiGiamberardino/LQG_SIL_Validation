...
## Generated on : Mon Jul 06 16:43:43 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LQR_Controller.exe
...
START_DIR                 = C:/Users/Danie/Desktop/MATLAB_NOTES
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = LQR_Controller_comp.rsp
CMD_FILE                  = LQR_Controller.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LQR_Controller.exe
...
DEFINES_STANDARD = -DMODEL=LQR_Controller -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/LQR_Controller_grt_rtw/LQR_Controller.c $(START_DIR)/LQR_Controller_grt_rtw/rt_nonfinite.c
...
OBJS = rt_logging.obj LQR_Controller.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/LQR_Controller_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/LQR_Controller_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/LQR_Controller_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/LQR_Controller_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/LQR_Controller_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
LQR_Controller.obj : $(START_DIR)/LQR_Controller_grt_rtw/LQR_Controller.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/LQR_Controller_grt_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
